// api/admin/leads.js — Protected admin endpoint to list and update leads
// captured from /api/contact (Google Ads LP and any future top-of-funnel form).
//
// Same auth pattern as /api/admin/intakes and /api/admin/reviews:
//   1. Supabase Auth JWT in Authorization: Bearer header (issued via magic link)
//   2. Authenticated user's email must be in ADMIN_EMAILS env var (comma-separated)
