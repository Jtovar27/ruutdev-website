...
const files = ['index.html', 'pages/solutions.html', 'pages/solutions/websites.html', 'pages/solutions/business-systems.html', 'pages/solutions/automation-ai.html', 'pages/portfolio.html', 'pages/process.html', 'pages/about.html', 'pages/contact.html', 'pages/pricing.html'];
...
if (!pricing.includes('/assets/js/rebuild.js')) throw new Error('pages/pricing.html: rebuilt interaction system is not loaded');
